...
angular.module('frontendApp').directive('hkChoropleth', function() {
    return {
        ...
        controller: ['$scope', 'GeoFiles', '$attrs', 'AreaSelection', '$parse', 'leafletData', function($scope, GeoFiles, $attrs, AreaSelection, $parse, leafletData) {
            ...
            // TODO:
            //     See if we want to add some base layer.
            //     This line is commented out as a quick solution to the Google Map API error.
            //     I don't have time to register one at present.
            $scope.layers = {
                // baselayers: {
                //   googleRoadMap: {
                //     name: 'Google Streets',
