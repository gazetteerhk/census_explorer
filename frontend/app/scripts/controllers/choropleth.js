  ...
  .controller('ChoroplethCtrl', ['$scope', 'CensusAPI', 'Indicators', '$filter',
    ...
    function($scope, CensusAPI, Indicators, $filter, $analytics) {
      ...
      var _genderRatioParser = function(data) {
        var d = CensusAPI.sumBy(CensusAPI.joinData(data.data), ['area',
          'column'
        ]);
      ...
      var _medianParserFactory = function(cfgObject) {
        return function(data) {
          ...
          var scale = d3.scale.ordinal().domain(data.options.row).range(
            d3.range(data.options.row.length));
      ...
      // 14 categories total
      var _medianMonthlyIncomeColors = _.clone(colorbrewer.Reds[7]).reverse()
        .concat(colorbrewer.Greens[7]);
      ...
      var _medianAgeConfig = {
        colors: _.clone(colorbrewer.Reds[9]).reverse().concat(colorbrewer.Greens[
          9]),
        valueVar: 'row'
      };
      ...
      var _pctParserFactory = function(rowsToAggregate) {
        return function(data) {
          var d = CensusAPI.asPercentage(CensusAPI.joinData(data.data),
            'area');
          var areaHash = {};
      ...
      $scope.indicators = [
        ...
        // Not very interesting
        {
          ...
          params: _.extend(_.clone(Indicators.queries.age, true),
            Indicators.queries.areaMedianModifier),
          ...
          params: Indicators.queries.age,
          config: _valueConfig,
          parser: _pctParserFactory(['h20_65', 'h21_70', 'h22_75', 'h23_80',
            'h24_85'
          ])
        },
        // Ethnicity
        ...
        // Family and housing
        {
          ...
          params: _.extend(_.clone(Indicators.queries.householdSize, true),
            Indicators.queries.areaMedianModifier),
          ...
          params: _.extend(_.clone(Indicators.queries.householdRent, true),
            Indicators.queries.areaMedianModifier),
          ...
          params: _.extend(_.clone(Indicators.queries.householdMortgage,
            true), Indicators.queries.areaMedianModifier),
          config: _medianMonthlyIncomeConfig,
          parser: _medianParserFactory(_medianMonthlyIncomeConfig)
        },
        // Education
        {
          ...
          params: _.extend(_.clone(Indicators.queries.educationalAttainment,
            true), Indicators.queries.areaModeModifier),
          ...
          config: _valueConfig,
          parser: _pctParserFactory(['a51_diplomacertificate',
            'a52_sub-degree', 'a53_degree'
          ])
        }, {
          name: 'mapper.options.percent_population_edu_students_travel',
          params: Indicators.queries.placeOfStudy,
          config: _valueConfig,
          parser: _pctParserFactory(['h44_hong', 'h45_kowloon', 'h46_new',
            'h47_other'
          ])
        },
        // Income and work
        {
          ...
          params: _.extend(_.clone(Indicators.queries.householdIncome, true),
            Indicators.queries.areaMedianModifier),
          config: _medianMonthlyIncomeConfig,
          parser: _medianParserFactory(_medianMonthlyIncomeConfig)
        }, {
          ...
          params: _.extend(_.clone(Indicators.queries.householdIncome, true),
            Indicators.queries.areaModeModifier),
          config: _medianMonthlyIncomeConfig,
          parser: _medianParserFactory(_medianMonthlyIncomeConfig)
        }, {
          name: 'mapper.options.most_common_occupation_men',
          params: _.extend(_.clone(Indicators.queries.occupationMale, true),
            Indicators.queries.areaModeModifier),
          ...
          params: _.extend(_.clone(Indicators.queries.occupationFemale,
            true), Indicators.queries.areaModeModifier),
          config: _modeOccupationConfig,
          parser: _medianParserFactory(_modeOccupationConfig)
        }, {
          name: 'mapper.options.most_common_industry_men',
          params: _.extend(_.clone(Indicators.queries.industryMale, true),
            Indicators.queries.areaModeModifier),
          config: _modeIndustryConfig,
          parser: _medianParserFactory(_modeIndustryConfig)
        }, {
          name: 'mapper.options.most_common_industry_women',
          params: _.extend(_.clone(Indicators.queries.industryFemale, true),
            Indicators.queries.areaModeModifier),
          config: _modeIndustryConfig,
          parser: _medianParserFactory(_modeIndustryConfig)
        }, {
          ...
          config: _valueConfig,
          parser: _pctParserFactory(['h64_hong', 'h65_kowloon', 'h66_new',
            'h67_other', 'h68_no', 'h70_places'
          ])
        },
        // Misc
        {
